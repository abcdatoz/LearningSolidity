...
contrac TestUniswapOptimalOneSidedSupply {
	address private constant FACTORY =  0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f;
	address private constant ROUTER = 0x623894238479283423;
	address private constant WETH = 0x892342342j204823;
	...
	function _swap(address _from, address _to, uint256 _amount) internal {
		IERC20(_from).approve(ROUTER, _tokenB);
		...
		_amount, 1, paht, address(this), block.timestamp);
	}
...
interface IERC20 {
	function totalSupply() exteranl view returns (uint256);
