...
interface IERC721 is IERC165 {
	...
	funtcion getApproved(uint256 tokenId) external view returns (address operator);
...
contract ERC721 is IERC721 {
	...
	event ApprovalFoAll ( address indexed owner, address indexed operator, bool aproved);
	...
	function balanceOf(address owner) external view returns(uint256)	 {
		require(owenr != address(0), "owner = zero address" );
	...
	funtion _mint (address to, uint256 id) internal {
