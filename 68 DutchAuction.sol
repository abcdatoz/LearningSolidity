...
interface IERC721 {
	funtion transferFrom(address _from, address _to, uint256 _nftId) external;
}
...
contract DutchAuction {
		...
		)
	{
		...
		require (_startPrice >= _discountRate * DURATION, "Starting price < min");
	...
	function buy() external payable {
		...
		nft.trasnferFrom (seller, msg.sender, nftId);
