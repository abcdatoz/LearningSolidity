...
contract Proxy {
	//AL variables must be privates, forward all calls to fallback
	...
	function _getAdmin() private view returns (address){
		retunr StorageSlot.getAddressSlot(ADMIN_SLOT).value;
	}
	...
	function _getImplementation() private view returns (address) {
		return StorageSlot.getAddress(IMPLEMENTATION_SLOT).value;
	}
	...
	function _delegate (address _implementation) internal virtual {
		...
		assembly {
			...
			//- returning 0 on error (eg. out of gas) and 1 to success
